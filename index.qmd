...
### v8 — Marine Atlas [PRE-RELEASE]{.badge-prerelease}

[Preview · 2026 — live alongside the current v7]{.timeline-date}

A ground-up rebuild as a global **Marine Atlas**. Preview apps are live now (links below); v7 remains the default. What differs from v7:
...
<div class="timeline-apps">
  <a href="https://app.marinesensitivity.org/scores_v8/" target="_blank">Composite Scores (v8) →</a>
  <a href="https://app.marinesensitivity.org/species_v8/" target="_blank">Species Distributions (v8) →</a>
</div>
```
:::
