...
![](images/mst-hero.svg){.hero-art fig-alt="Marine Sensitivity Toolkit — species distributions and extinction risk, scored across US ocean waters"}

::: {.hero-text}

![](images/mst-mark-dark.svg){.mst-mark fig-alt=""}
...
::: {.timeline-item .preview}
### v7.1 — sea-turtle core habitat + coverage floor [PRE-RELEASE · REVIEWERS]{.badge-prerelease}

[Preview · September 2026 — a patch of v7, under review; v7 remains the default]{.timeline-date}
...
```{=html}
<div class="timeline-apps">
  <a href="https://preview.marinesensitivity.org/v7b/scores/" target="_blank">Composite Scores (v7.1) →</a>
  <a href="https://preview.marinesensitivity.org/v7b/species/" target="_blank">Species Distributions (v7.1) →</a>
  <a href="https://preview.marinesensitivity.org/docs/v7b/" target="_blank">Documentation (v7.1) →</a>
</div>
```
:::
